...
namespace AvaloniaManagedLibraryTest.Models;

public sealed class NativeLibraryItem : ReactiveObject
{
    private bool _isSelected;

    public NativeLibraryItem(string rootDirectory, string fullPath)
    {
        FullPath = fullPath;
        ...
        RelativeDirectory = GetRelativeDirectory(rootDirectory, info.DirectoryName);
    }
