...
set "project_paths=src\csharp.test.dynamic-success src\csharp.test.static-success1 src\csharp.test.static-success2\csharp.test.static src\csharp.test.static-success3\csharp.test.static"
